...
HD_PWD='C:/Users/progenor/VivadoProjects/PersonalCPU/PersonalCPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IfAndDec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IfAndDec.tcl
