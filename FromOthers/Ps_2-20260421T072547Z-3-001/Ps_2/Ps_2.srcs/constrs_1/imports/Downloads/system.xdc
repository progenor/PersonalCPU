...
#set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { Interrupt }]; #IO_L7P_T1_AD2P_35 Sch=sw[1]
...
# --- LCD CONTROL (3 bit) es test_clk a PmodB maradek labain ---
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { lcd_control[0] }]; # Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { lcd_control[1] }]; # Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { lcd_control[2] }]; # Sch=jb_p[3]
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { test_clk }];       # Sch=jb_n[3]
...
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { E }];  # Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { Rw }]; # Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { Rs }]; # Sch=jb_p[3]
